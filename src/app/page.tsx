...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero */}
      <section className="relative pt-32 pb-24 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950">
        {/* Background blobs */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-3 gap-6 max-w-lg mx-auto">
            {[
              ...
              <div key={label} className="bg-white/5 border border-white/10 rounded-2xl px-4 py-5 backdrop-blur-sm">
